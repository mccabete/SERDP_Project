...
data <- list(num_points = length(temp_data$gs), 
             ...
             Ca = temp_data$Ca, 
             vpd = temp_data$vpd,
             gs = temp_data$gs, stomatal_slope_var = stomatal_slope_var, stomatal_slope_average = stomatal_slope_average)
...
jags.out   <- coda.samples (model = j.model,
                            variable.names = c("m","min_conductance","D_0"),
                                n.iter = 1000)
plot(jags.out)
